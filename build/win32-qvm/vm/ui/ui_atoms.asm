...
;991:/*
;992:=================
;993:UI_ConsoleCommand
;994:=================
;995:*/
;996:qboolean UI_ConsoleCommand( int realTime ) {
line 999
;997:	char	*cmd;
;998:
;999:	uis.frametime = realTime - uis.realtime;
ADDRGP4 uis
ADDRFP4 0
INDIRI4
ADDRGP4 uis+4
...
line 1005
;1003:
;1004:	// ensure minimum menu data is available
;1005:	Menu_Cache();
ADDRGP4 Menu_Cache
CALLV
pop
line 1007
;1006:
;1007:	if ( Q_stricmp (cmd, "levelselect") == 0 ) {
ADDRLP4 0
INDIRP4
ARGP4
ADDRGP4 $421
...
;1010:	}
;1011:
;1012:	if ( Q_stricmp (cmd, "postgame") == 0 ) {
ADDRLP4 0
INDIRP4
ARGP4
ADDRGP4 $424
...
;1015:	}
;1016:
;1017:	if ( Q_stricmp (cmd, "ui_cache") == 0 ) {
ADDRLP4 0
INDIRP4
ARGP4
ADDRGP4 $427
...
;1020:	}
;1021:
;1022:	if ( Q_stricmp (cmd, "ui_cinematics") == 0 ) {
ADDRLP4 0
INDIRP4
ARGP4
ADDRGP4 $430
...
;1025:	}
;1026:
;1027:	if ( Q_stricmp (cmd, "ui_teamOrders") == 0 ) {
ADDRLP4 0
INDIRP4
ARGP4
ADDRGP4 $433
...
;1030:	}
;1031:
;1032:	if ( Q_stricmp (cmd, "iamacheater") == 0 ) {
ADDRLP4 0
INDIRP4
ARGP4
ADDRGP4 $436
...
;1035:	}
;1036:
;1037:	if ( Q_stricmp (cmd, "iamamonkey") == 0 ) {
ADDRLP4 0
INDIRP4
ARGP4
ADDRGP4 $439
...
;1040:	}
;1041:
;1042:	if ( Q_stricmp (cmd, "ui_cdkey") == 0 ) {
ADDRLP4 0
INDIRP4
ARGP4
ADDRGP4 $442
...
;1063:=================
;1064:*/
;1065:void UI_Init( void ) {
line 1066
;1066:	UI_RegisterCvars();
ADDRGP4 UI_RegisterCvars
CALLV
pop
line 1068
;1067:
;1068:	UI_InitGameinfo();
ADDRGP4 UI_InitGameinfo
CALLV
pop
line 1071
;1069:
;1070:	// cache redundant calulations
;1071:	UI_VideoCheck( -99999 );
CNSTI4 -99999
ARGI4
ADDRGP4 UI_VideoCheck
CALLV
...
;1081:/*
;1082:================
;1083:UI_AdjustFrom640
;1084:
;1085:Adjusted for resolution and screen aspect ratio
;1086:================
;1087:*/
;1088:void UI_AdjustFrom640( float *x, float *y, float *w, float *h ) {
line 1090
;1089:	// expect valid pointers
;1090:	*x = *x * uis.scale + uis.biasX;
ADDRLP4 0
ADDRFP4 0
INDIRP4
ASGNP4
...
;1104:
;1105:
;1106:void UI_DrawHandlePic( float x, float y, float w, float h, qhandle_t hShader ) {
line 1112
;1107:	float	s0;
;1108:	float	s1;
;1109:	float	t0;
;1110:	float	t1;
;1111:
;1112:	if( w < 0 ) {	// flip about vertical
ADDRFP4 8
INDIRF4
CNSTF4 0
GEF4 $456
...
line 1122
;1121:
;1122:	if( h < 0 ) {	// flip about horizontal
ADDRFP4 12
INDIRF4
CNSTF4 0
GEF4 $458
...
pop
line 1133
;1133:	trap_R_DrawStretchPic( x, y, w, h, s0, t0, s1, t1, hShader );
ADDRFP4 0
INDIRF4
ARGF4
ADDRFP4 4
...
;1135:
;1136:
;1137:static void UI_DrawCursor( float x, float y, float w, float h ) {
line 1139
;1138:
;1139:	UI_AdjustFrom640( &x, &y, &w, &h );
ADDRFP4 0
ARGP4
ADDRFP4 4
ARGP4
...
pop
line 1140
;1140:	trap_R_DrawStretchPic( x, y, w, h, 0, 0, 1, 1, uis.cursor );
ADDRFP4 0
INDIRF4
ARGF4
ADDRFP4 4
...
;1146:UI_FillRect
;1147:
;1148:Coordinates are 640*480 virtual values
;1149:=================
;1150:*/
;1151:void UI_FillRect( float x, float y, float width, float height, const float *color ) {
line 1152
;1152:	trap_R_SetColor( color );
ADDRFP4 16
INDIRP4
ARGP4
ADDRGP4 trap_R_SetColor
...
line 1154
;1153:
;1154:	UI_AdjustFrom640( &x, &y, &width, &height );
ADDRFP4 0
ARGP4
ADDRFP4 4
ARGP4
...
pop
line 1155
;1155:	trap_R_DrawStretchPic( x, y, width, height, 0, 0, 0, 0, uis.whiteShader );
ADDRFP4 0
INDIRF4
ARGF4
ADDRFP4 4
...
;1162:UI_DrawRect
;1163:
;1164:Coordinates are 640*480 virtual values
;1165:=================
;1166:*/
;1167:void UI_DrawRect( float x, float y, float width, float height, const float *color ) {
line 1168
;1168:	trap_R_SetColor( color );
ADDRFP4 16
INDIRP4
ARGP4
ADDRGP4 trap_R_SetColor
...
line 1170
;1169:
;1170:	UI_AdjustFrom640( &x, &y, &width, &height );
ADDRFP4 0
ARGP4
ADDRFP4 4
ARGP4
...
line 1172
;1171:
;1172:	trap_R_DrawStretchPic( x, y, width, 1, 0, 0, 0, 0, uis.whiteShader );
ADDRFP4 0
INDIRF4
ARGF4
ADDRFP4 4
...
pop
line 1173
;1173:	trap_R_DrawStretchPic( x, y, 1, height, 0, 0, 0, 0, uis.whiteShader );
ADDRFP4 0
INDIRF4
ARGF4
ADDRFP4 4
...
pop
line 1174
;1174:	trap_R_DrawStretchPic( x, y + height - 1, width, 1, 0, 0, 0, 0, uis.whiteShader );
ADDRFP4 0
INDIRF4
ARGF4
ADDRFP4 4
...
pop
line 1175
;1175:	trap_R_DrawStretchPic( x + width - 1, y, 1, height, 0, 0, 0, 0, uis.whiteShader );
ADDRFP4 0
INDIRF4
ADDRFP4 8
INDIRF4
...
line 1180
;1179:
;1180:void UI_SetColor( const float *rgba ) {
line 1181
;1181:	trap_R_SetColor( rgba );
ADDRFP4 0
INDIRP4
ARGP4
ADDRGP4 trap_R_SetColor
...
line 1184
;1183:
;1184:void UI_UpdateScreen( void ) {
line 1185
;1185:	trap_UpdateScreen();
...
;1191:=================
;1192:*/
;1193:void UI_Refresh( int realtime )
;1194:{
line 1195
;1195:	uis.frametime = realtime - uis.realtime;
ADDRGP4 uis
ADDRFP4 0
INDIRI4
ADDRGP4 uis+4
...
line 1198
;1197:
;1198:	if ( !( trap_Key_GetCatcher() & KEYCATCH_UI ) ) {
ADDRLP4 0
ADDRGP4 trap_Key_GetCatcher
CALLI4
ASGNI4
...
;1211:			trap_R_DrawStretchPic( 0, 0, uis.glconfig.vidWidth, uis.glconfig.vidHeight, 0, 0, 1, 1, uis.menuBackNoLogoShader );
CNSTF4 0
ARGF4
CNSTF4 0
ARGF4
...
pop
line 1212
;1212:			if ( uis.activemenu->showlogo ) {
ADDRGP4 uis+20
INDIRP4
CNSTI4 284
ADDP4
...
EQI4 $487
line 1213
;1213:				UI_DrawHandlePic( 0, 0, SCREEN_WIDTH, SCREEN_HEIGHT, uis.menuBackShader );
CNSTF4 0
ARGF4
CNSTF4 0
ARGF4
...
line 1222
;1221:
;1222:		if( uis.firstdraw ) {
ADDRGP4 uis+11468
INDIRI4
CNSTI4 0
EQI4 $496
line 1223
;1223:			UI_MouseEvent( 0, 0 );
CNSTI4 0
ARGI4
CNSTI4 0
ARGI4
...
pop
line 1230
;1230:	UI_DrawCursor( uis.cursorx-16, uis.cursory-16, 32, 32 );
ADDRGP4 uis+8
INDIRF4
CNSTF4 1098907648
SUBF4
...
;1234:	{
line 1236
;1235:		// cursor coordinates
;1236:		UI_DrawString( 0, 0, va( "(%1.1f,%1.1f)", uis.cursorx, uis.cursory ), UI_LEFT|UI_SMALLFONT, colorRed );
ADDRGP4 $505
ARGP4
ADDRGP4 uis+8
INDIRF4
...
;1238:#endif
;1239:
;1240:	// delay playing the enter sound until after the
;1241:	// menu has been drawn, to avoid delay while
;1242:	// caching images
;1243:	if (m_entersound)
ADDRGP4 m_entersound
INDIRI4
CNSTI4 0
EQI4 $508
...
;1244:	{
line 1245
;1245:		trap_S_StartLocalSound( menu_in_sound, CHAN_LOCAL_SOUND );
...
line 1251
;1249:
;1250:void UI_DrawTextBox (int x, int y, int width, int lines)
;1251:{
line 1252
;1252:	UI_FillRect( x + BIGCHAR_WIDTH/2, y + BIGCHAR_HEIGHT/2, ( width + 1 ) * BIGCHAR_WIDTH, ( lines + 1 ) * BIGCHAR_HEIGHT, colorBlack );
ADDRFP4 0
INDIRI4
CNSTI4 8
ADDI4
...
pop
line 1253
;1253:	UI_DrawRect( x + BIGCHAR_WIDTH/2, y + BIGCHAR_HEIGHT/2, ( width + 1 ) * BIGCHAR_WIDTH, ( lines + 1 ) * BIGCHAR_HEIGHT, colorWhite );
ADDRFP4 0
INDIRI4
CNSTI4 8
ADDI4
...
line 1257
;1255:
;1256:qboolean UI_CursorInRect (int x, int y, int width, int height)
;1257:{
line 1258
;1258:	if (uis.cursorx < x ||
ADDRLP4 0
ADDRFP4 0
INDIRI4
ASGNI4
...
line 1262
;1259:		uis.cursory < y ||
;1260:		uis.cursorx > x+width ||
;1261:		uis.cursory > y+height)
;1262:		return qfalse;
CNSTI4 0
RETI4
ADDRGP4 $511
